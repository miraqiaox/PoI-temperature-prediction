...
parser.add_argument('--str_root', default='/mnt/share1/liqiao/EAAI_dis/structure/400/random_monitoring', type=str, help='struc mat root')
...
for epoch in range(args.epochs):
    ...
    if train_loss < mae:
        torch.save(model.state_dict(),
                    "/mnt/share1/liqiao/EAAI_dis/graph_gcn/model_pkl/random_monitoring/net_hidf{:d}_nhid{:d}_bs{:d}.pth".format(
