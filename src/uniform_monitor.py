...
parser.add_argument('--str_root', default='./structure/400/uniform_monitoring', type=str, help='struc mat root')
...
for epoch in range(args.epochs):
    ...
    if train_loss < mae:
        torch.save(model.state_dict(),
                    "./model_pkl/uniform_monitoring/net_hidf{:d}_nhid{:d}_bs{:d}_{:d}.pth".format(
