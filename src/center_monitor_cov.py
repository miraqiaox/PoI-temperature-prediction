...
parser.add_argument('--str_root', default='./structure/400/center_monitoring_cov', type=str, help='struc mat root')
...
for epoch in range(args.epochs):
    ...
    if train_loss < mae:
        torch.save(model.state_dict(),
                    "./model_pkl/center_monitoring_cov/net_hidf{:d}_nhid{:d}_bs{:d}_{:d}.pth".format(
