...
from function import build_cov_graph, Graph_embedding, load_data, train, test
...
parser.add_argument('--str_root', default='/mnt/share1/liqiao/EAAI_dis/structure/400/center_monitoring_cov', type=str, help='struc mat root')
...
traindata = torch.cat((trainset[0], trainset[1]), dim=1)
traindata = torch.squeeze(traindata, -1)
traindata = traindata.cpu().numpy()
# print(traindata.shape)
# print(trainset[0].size(), trainset[1].size())
# 定义dataloader
...
for epoch in range(args.epochs):
    ...
    if train_loss < mae:
        torch.save(model.state_dict(),
                    "/mnt/share1/liqiao/EAAI_dis/graph_gcn/model_pkl/center_monitoring_cov/net_hidf{:d}_nhid{:d}_bs{:d}_{:d}.pth".format(
