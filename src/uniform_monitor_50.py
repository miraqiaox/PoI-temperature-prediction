...
for j in range(6):
    for i in range(7):
        ...
        x[i + 7 * a, 0] = (j + 1) * 25 - 1
    a += 1
x[42:, :] = np.array([[174, 21], [174, 43], [174, 65], [174, 87], [174, 109], [174, 131], [174, 153], [174, 175]])
x_point = np.array(x, dtype=int)
...
# Model and optimizer
model = GCN(infeat=1, n_in=50, outfeat=1, n_out=n_out, str_feat=args.embed_size, 
