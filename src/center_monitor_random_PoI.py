...
parser.add_argument('--str_root', default='/mnt/share1/liqiao/EAAI_dis/structure/400/center_monitoring_random_PoI', type=str, help='struc mat root')
...
pred_point = scio.loadmat('/mnt/share1/liqiao/EAAI_dis/graph_gcn/model_pkl/center_monitoring_random_PoI/random_PoI.mat')
y_point = np.array(pred_point['PoI'], dtype=int)
