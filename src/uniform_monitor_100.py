...
parser.add_argument('--str_root', default='/mnt/share1/liqiao/EAAI_dis/structure/400/uniform_monitoring_100', type=str, help='struc mat root')
...
# x_point = np.array([[49, 49], [49, 99], [49, 149], [99, 49], [99, 99], [99, 149], [149, 39], [149, 79], [149, 119], [149, 159]], dtype=int)
x_point = np.zeros((100, 2))
for i in range(10):
    for j in range(10):
        x_point[i + 10 * j, 0] = (i + 1) * 18 + 1
        x_point[i + 10 * j, 1] = (j + 1) * 18 + 1

# print(x_point)
x_point = np.array(x_point, dtype=int)
...
# Model and optimizer
model = GCN(infeat=1, n_in=100, outfeat=1, n_out=n_out, str_feat=args.embed_size, 
